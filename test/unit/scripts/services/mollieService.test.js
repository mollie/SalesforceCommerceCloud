...
const constants = { ...paymentConstants, ...orderConstants, ...refundConstants, ...shipmentConstants, ...methodConstants };
...
const mollieService = proxyquire(`${base}/int_mollie/cartridge/scripts/services/mollieService`, {
    ...
    '*/cartridge/scripts/services/mollie/payment/updatePayment': stubs.mollieHandlerStub,
    ...
    '*/cartridge/scripts/services/mollie/order/updateOrder': stubs.mollieHandlerStub,
