...
Order.CONFIRMATION_STATUS_NOTCONFIRMED = 0;

Order.EXPORT_STATUS_EXPORTED = 1;
Order.EXPORT_STATUS_FAILED = 3;
Order.EXPORT_STATUS_NOTEXPORTED = 0;
Order.EXPORT_STATUS_READY = 2;

Order.ORDER_STATUS_CANCELLED = 6;
Order.ORDER_STATUS_COMPLETED = 5;
Order.ORDER_STATUS_CREATED = 0;
Order.ORDER_STATUS_FAILED = 8;
Order.ORDER_STATUS_NEW = 3;
Order.ORDER_STATUS_OPEN = 4;
Order.ORDER_STATUS_REPLACED = 7;

Order.PAYMENT_STATUS_NOTPAID = 0;
Order.PAYMENT_STATUS_PAID = 2;
Order.PAYMENT_STATUS_PARTPAID = 1;

Order.SHIPPING_STATUS_NOTSHIPPED = 0;
Order.SHIPPING_STATUS_PARTSHIPPED = 1;
Order.SHIPPING_STATUS_SHIPPED = 2;
